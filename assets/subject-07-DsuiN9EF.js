...
sandbox:
  phases:
    evaluation:
      timeout: 3600s  # 1 hour max for eval`}),e.jsx(o,{title:"Example Blueprint Library",headers:["Blueprint","Base","Use Case","Key Additions"],rows:[["ml-training-pytorch","CUDA base","General ML training","PyTorch, GPU support, experiment tracking"],["nlp-evaluation","ml-training-pytorch","NLP benchmarking","datasets, evaluate, metrics scripts"],["rl-training","ml-training-pytorch","Reinforcement learning","gymnasium, stable-baselines3"],["data-science","Python base","Data analysis","pandas, scikit-learn, matplotlib, Jupyter"],["llm-fine-tune","ml-training-pytorch","LLM fine-tuning","transformers, peft, bitsandbytes, Flash Attention"]]}),e.jsx(s,{type:"info",title:"Sharing Blueprints",children:e.jsxs("p",{children:["Blueprints can be published to a blueprint registry for team-wide or public use. Use ",e.jsx("code",{children:"openclaw blueprint publish ml-training-pytorch"})," to share a blueprint. Others can use it with ",e.jsx("code",{children:"--blueprint registry/ml-training-pytorch:2.1.0"}),". Version pinning ensures everyone uses the same environment."]})}),e.jsx("h2",{className:"text-xl font-bold text-gray-800 dark:text-gray-200 mt-8",children:"Specialized Research Configurations"}),e.jsx(t,{title:"LLM fine-tuning blueprint with LoRA",language:"yaml",code:`# blueprints/llm-fine-tune/blueprint.yaml
name: llm-fine-tune
version: 1.2.0
extends: ml-training-pytorch
...
#
# Result: COMPLIANT (1 documented exception)`,language:"bash"},{title:"Document exceptions",content:"Some services (like GitHub) do not offer regional endpoints. Document these exceptions with justification and data classification analysis."}]}),e.jsx(o,{title:"Regional Deployment Patterns",headers:["Pattern","Description","Complexity","Best For"],rows:[["Single region","All components in one approved region","Low","Small teams, single jurisdiction"],["Multi-region, routed","Agents route to nearest approved endpoint","Medium","Global teams, single regulation"],["Isolated regions","Fully separate deployments per region","High","Multiple regulations, data sovereignty"],["Hybrid","Non-sensitive data global, sensitive data regional","Medium-High","Complex compliance landscape"]]}),e.jsx(n,{question:"Your EU-based agent reviews code for a project that includes US customer PII in test fixtures. The inference provider processes requests in the EU. Is this compliant with GDPR?",options:["Yes, because the inference happens in the EU","No, because the test fixtures contain US customer data which should not exist in the EU","It depends on whether data processing agreements are in place with the inference provider and whether the PII in test fixtures is real or synthetic","Yes, because GDPR does not apply to AI inference"],correctIndex:2,explanation:"GDPR compliance depends on several factors: whether the PII is real or synthetic (synthetic data is not personal data), whether a Data Processing Agreement (DPA) exists with the inference provider, and whether the processing has a lawful basis. The geographic location of processing is one factor but not the only one. Real PII in test fixtures is a separate concern that should be addressed by using synthetic test data."}),e.jsx(i,{references:[{title:"NemoClaw Data Residency Guide",url:"https://github.com/openclaw-org/nemoclaw/blob/main/docs/data-residency.md",type:"docs",description:"Complete guide to configuring data residency controls."},{title:"GDPR Data Processing Requirements",url:"https://gdpr.eu/article-28-processor/",type:"docs",description:"GDPR Article 28 requirements for data processors."},{title:"Anthropic Enterprise Data Processing",url:"https://www.anthropic.com/policies/privacy",type:"docs",description:"Anthropic data processing practices and regional availability."}]})]})}const pe=Object.freeze(Object.defineProperty({__proto__:null,default:L},Symbol.toStringTag,{value:"Module"}));export{ue as A,pe as B,U as a,W as b,Y as c,z as d,H as e,F as f,$ as g,K as h,V as i,Q as j,Z as k,J as l,X as m,ee as n,te as o,ae as p,se as q,oe as r,D as s,ne as t,ie as u,re as v,le as w,ce as x,de as y,me as z};
