...
echo "=== Check Complete ==="`}),e.jsx("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:"If all checks pass, Docker is ready for NemoClaw. The next step is to install NemoClaw itself and run the onboarding process, which downloads the sandbox blueprint and creates your first sandbox."})]})}const V=Object.freeze(Object.defineProperty({__proto__:null,default:u},Symbol.toStringTag,{value:"Module"}));function p(){return e.jsxs("div",{className:"space-y-6",children:[e.jsx("h1",{className:"text-3xl font-bold text-gray-900 dark:text-white",children:"Installing NemoClaw and Onboarding"}),e.jsx("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:"With all dependencies in place -- Node.js 20+, npm 10+, Docker running without sudo, and Git installed -- you are ready to install NemoClaw and create your first sandbox. The installation process has two phases: installing the NemoClaw CLI, and running the onboard command that downloads the blueprint image and creates a sandbox."}),e.jsx("h2",{className:"text-2xl font-semibold text-gray-800 dark:text-gray-100 mt-8",children:"Phase 1: Install the NemoClaw CLI"}),e.jsx("p",{className:"text-gray-700 dark:text-gray-300 leading-relaxed",children:"NemoClaw provides a one-line install script that downloads the CLI, verifies its integrity, and installs it globally on your system. This script handles architecture detection (x86_64 vs ARM64) automatically."}),e.jsx(o,{title:"Install the NemoClaw CLI",steps:[{title:"Run the install script",content:"This downloads and installs the NemoClaw CLI binary and its Node.js dependencies.",code:"curl -fsSL https://www.nvidia.com/nemoclaw.sh | bash"},{title:"Verify the installation",content:"Check that the nemoclaw command is available and displays its version.",code:`nemoclaw --version
