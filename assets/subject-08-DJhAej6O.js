...
source ~/.bashrc`})}),e.jsx(a,{number:5,title:"Verify CUDA installation",children:e.jsx(t,{language:"bash",children:`# Check CUDA compiler version
nvcc --version
...
docker run hello-world`})}),e.jsx(a,{number:7,title:"Install the NVIDIA Container Toolkit",children:e.jsx(t,{language:"bash",children:`# Configure the repository
...
sudo systemctl restart docker`})}),e.jsx(a,{number:8,title:"Verify GPU access from Docker",children:e.jsx(t,{language:"bash",children:`# Run nvidia-smi inside a container
...
curl http://localhost:11434/v1/models | jq .`}),e.jsxs(i,{type:"info",title:"Ollama with Docker",children:[e.jsx("p",{children:"Ollama can also run inside Docker, which may be preferable for consistency with other containerized services in your NemoClaw stack. The official Docker image supports GPU passthrough."}),e.jsx(t,{language:"bash",children:`docker run -d --gpus all \\
...
# ├── blueprint.yaml
# ├── policies/
# └── scripts/`})}),e.jsx(a,{number:2,title:"Define the blueprint manifest",children:e.jsx(t,{language:"yaml",title:"blueprint.yaml",children:`name: "doc-generator"
version: "0.1.0"
...
init:
  ...
  scripts:
    - "scripts/init.sh"`})}),e.jsx(a,{number:3,title:"Write the system prompt",children:e.jsx(t,{language:"markdown",title:"system-prompt.md",children:`You are a documentation generator agent. Your job is to read source code
...
3. Usage examples
4. Type signatures where applicable`})}),e.jsx(a,{number:4,title:"Define the network policy",children:e.jsx(t,{language:"yaml",title:"policies/network.yaml",children:`# Network policy: only allow LLM endpoint
default: deny
...
# - host: "localhost"
#   port: 8000`})}),e.jsx(a,{number:5,title:"Define the filesystem policy",children:e.jsx(t,{language:"yaml",title:"policies/filesystem.yaml",children:`# Filesystem policy: read source, write docs
default: deny
...
rules:
  ...
  - path: "/tmp"
    access: read-write
    recursive: true`})}),e.jsx(a,{number:6,title:"Define resource limits",children:e.jsx(t,{language:"yaml",title:"policies/resources.yaml",children:`# Resource limits for the doc-generator agent
cpu:
...
time:
  max_runtime_minutes: 30  # kill agent after 30 minutes`})}),e.jsx(a,{number:7,title:"Create the initialization script",children:e.jsx(t,{language:"bash",title:"scripts/init.sh",children:`#!/bin/bash
...
nemoclaw debug strace 12345 -e trace=open,openat,access,connect,bind 2>&1 | grep EACCES`}),e.jsx(a,{number:1,title:"Diagnosing a filesystem access denial",children:e.jsx(t,{language:"bash",children:`# The agent reports "Permission denied" when trying to read a file
...
# custom seccomp profile in the SCMP_ACT_ALLOW list.`}),e.jsx("h2",{className:"text-2xl font-semibold text-gray-800 dark:text-gray-100 mt-8",children:"Network Connectivity Troubleshooting"}),e.jsx(a,{number:2,title:"Systematic network debugging",children:e.jsx(t,{language:"bash",children:`# Step 1: Check if DNS resolution works inside the sandbox
...
# Copy this output into your bug report`})]}),e.jsxs(a,{number:2,title:"Write a clear reproduction case",children:[e.jsx("p",{children:"The most important part of a bug report is a reproduction case -- a minimal set of steps that reliably triggers the bug. The best reproduction cases are self-contained: someone should be able to copy-paste your commands and see the same problem."}),e.jsx(t,{language:"markdown",children:`## Steps to reproduce
...
127.0.0.1 but the sandbox's /etc/hosts does not contain this mapping.`})]}),e.jsx(a,{number:3,title:"Include relevant logs",children:e.jsx(t,{language:"bash",children:`# Run with verbose logging to capture detailed output
...
}`}),e.jsx("h2",{className:"text-2xl font-semibold text-gray-800 dark:text-gray-100 mt-8",children:"Submitting a Pull Request"}),e.jsx(a,{number:3,title:"Commit, push, and open a PR",children:e.jsx(t,{language:"bash",children:`# Stage your changes
